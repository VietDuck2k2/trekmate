   ...
   const loadTripData = async () => {
      try {
         ...
         if (trip.createdBy._id !== user._id) {
            setError('You can only edit trips you created');
            return;
         }
      ...
      return (
         <Layout>
            <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
               ...
               <h1 className="text-2xl font-bold text-slate-800 dark:text-white mb-2">Error Loading Trip</h1>
               <p className="text-red-500 mb-6">{error}</p>
               <button onClick={() => navigate('/')} className="px-6 py-3 bg-primary text-white rounded-xl font-bold hover:bg-emerald-700 transition">Back to Home</button>
            </div>
         </Layout>
      );
   }
         ...
         <div className="max-w-7xl mx-auto px-6 py-12 md:py-20 mt-12">
            <div className="mb-12">
               <div className="flex items-center gap-4 mb-2">
                  ...
                  <h1 className="text-4xl font-bold text-slate-900 dark:text-white">Edit Trip</h1>
               </div>
               <p className="text-slate-500 dark:text-slate-400 ml-14">Update details for your upcoming adventure.</p>
            </div>
                        ...
                        <div className="space-y-4">
                           ...
                           <div>
                              <div className="flex justify-between items-center mb-2">
                                 <label className="text-xs font-bold text-slate-400 uppercase tracking-wider">Gallery Photos (Max 3)</label>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                 ...
                                 {formData.photos.length === 0 && (
                                    <div className="text-slate-400 text-sm italic col-span-3 text-center py-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl">
                                       No additional photos. Click "Add Photo" to add some.
                                    </div>
                                 )}
                              </div>
                           </div>
