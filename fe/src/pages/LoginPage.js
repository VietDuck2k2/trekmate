         ...
         <div className="relative hidden w-full lg:block lg:w-1/2 xl:w-3/5">
            ...
            <div className="absolute inset-0 flex flex-col justify-between p-12">
               ...
               <div className="max-w-md">
                  <h2 className="font-display text-white text-5xl leading-tight mb-6 font-bold">Khám phá vẻ đẹp hoang sơ của thế giới.</h2>
                  <p className="text-white/90 text-lg leading-relaxed">
                     Tham gia cộng đồng phượt thủ và tìm kiếm hành trình tuyệt vời tiếp theo. Mọi đỉnh núi đều trong tầm tay.
                  </p>
               </div>
         ...
         <div className="flex w-full flex-col justify-center px-6 py-12 lg:w-1/2 xl:w-2/5 sm:px-12 md:px-24">
            <div className="mx-auto w-full max-w-sm">
               <div className="mb-10 text-center lg:text-left">
                  <h1 className="font-display text-4xl font-bold text-slate-900 dark:text-white mb-3">Đăng nhập TrekMate</h1>
                  <p className="text-slate-500 dark:text-slate-400">Chào mừng trở lại! Vui lòng nhập thông tin của bạn.</p>
               </div>
               ...
               <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  <div>
                     <div className="flex items-center justify-between mb-1.5">
                        ...
                        <Link className="text-xs font-semibold text-primary hover:text-emerald-700 transition" to="/forgot-password">Quên mật khẩu?</Link>
                     </div>
                     <input
                        className="block w-full rounded-xl border border-slate-200 bg-slate-50 dark:bg-slate-800 dark:border-slate-700 dark:text-white px-4 py-3 text-slate-900 shadow-sm transition focus:border-primary focus:ring-primary focus:ring-2 sm:text-sm outline-none"
                        id="password"
                  ...
                  <div className="flex items-center">
                     ...
                     <label className="ml-2 block text-sm text-slate-700 dark:text-slate-300" htmlFor="remember-me">Ghi nhớ đăng nhập trong 30 ngày</label>
                  </div>
                  <button
               ...
               <div className="mt-8">
                  <div className="relative">
                     ...
                     <div className="relative flex justify-center text-xs uppercase">
                        <span className="bg-white dark:bg-slate-900 px-3 text-slate-500 dark:text-slate-400">Hoặc tiếp tục với</span>
                     </div>
                  </div>
                  <div className="mt-6">
                     <button
               ...
               <p className="mt-10 text-center text-sm text-slate-500 dark:text-slate-400">
                  Chưa có tài khoản? <Link className="font-semibold text-primary hover:text-emerald-700 transition" to="/register">Đăng ký tại đây</Link>
               </p>
            </div>
         </div>
      </div>
